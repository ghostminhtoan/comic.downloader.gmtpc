    ...
    public partial class MainWindow : Window
    {
        ...
        private void EnsureLightNovelFloatingControlWindow()
        {
            ...
            _lightNovelFloatingControlWindow = new SystemFloatingControlWindow(
                ...
                () => Dispatcher.BeginInvoke(new Action(ToggleAutoDownloadFromFloating)),
                () => Dispatcher.BeginInvoke(new Action(ToggleListThumbnailFromFloating)),
                () => Dispatcher.BeginInvoke(new Action(ToggleNewWindowFromFloating)),
