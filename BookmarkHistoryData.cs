...
namespace get_link_manga
{
    ...
    public class BookmarkHistoryManager
    {
        ...
        {
            _dataDir = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "autosave");
            _bookmarksPath = Path.Combine(_dataDir, "bookmarks.json");
            _readerPageBookmarksPath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "reader-page-bookmarks.md");
            _legacyReaderPageBookmarksBinaryPath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "reader-page-bookmarks.gmrb");
            _legacyReaderPageBookmarksJsonPath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "reader-page-bookmarks.json");
