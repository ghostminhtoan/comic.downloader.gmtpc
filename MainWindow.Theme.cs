...
namespace get_link_manga
{
    public partial class MainWindow : Window
    {
        ...
        {
            var pinButton = FindName("btnPinWindow") as System.Windows.Controls.Primitives.ToggleButton;
            if (pinButton != null)
            {
                pinButton.IsChecked = Topmost;
                pinButton.ToolTip = _isVietnameseUi
                    ? (Topmost ? "Bỏ ghim cửa sổ" : "Ghim cửa sổ")
                    : (Topmost ? "Unpin window" : "Pin window");
            }
            else
            {
                var pinBtn = FindName("btnMainTheme") as Button
                ...
                if (pinBtn != null)
                {
                    ...
                    pinBtn.ToolTip = _isVietnameseUi
                        ? (isPinned ? "Bỏ ghim cửa sổ" : "Ghim cửa sổ")
                        : (isPinned ? "Unpin window" : "Pin window");
                    pinBtn.Foreground = accentBrush;
                    pinBtn.BorderBrush = accentBrush;
                }
            }
        }
    }
