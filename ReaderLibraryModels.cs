...
namespace get_link_manga
{
    ...
    internal sealed class ReaderChapterIssueItem : NotificationObject, IReaderWatchCheckable
    {
        ...
        public string DomainLabel
        {
            ...
            set
            {
                if (!string.Equals(_domainLabel, value, StringComparison.Ordinal))
                {
                    _domainLabel = value;
        ...
        public string BookName
        {
            ...
            set
            {
                if (!string.Equals(_bookName, value, StringComparison.Ordinal))
                {
                    _bookName = value;
        ...
        public string BookLink
        {
            ...
            set
            {
                if (!string.Equals(_bookLink, value, StringComparison.Ordinal))
                {
                    _bookLink = value;
                    RaisePropertyChanged(nameof(BookLink));
                }
            }
        }
        ...
        public string ChapterLabel
        {
            ...
            set
            {
                if (!string.Equals(_chapterLabel, value, StringComparison.Ordinal))
                {
                    _chapterLabel = value;
                    RaisePropertyChanged(nameof(ChapterLabel));
                }
            }
        }

        private string _missingChapterLabel;
        public string MissingChapterLabel
        {
            get => _missingChapterLabel;
            set
            {
                if (!string.Equals(_missingChapterLabel, value, StringComparison.Ordinal))
                {
                    _missingChapterLabel = value;
                    RaisePropertyChanged(nameof(MissingChapterLabel));
                    RaisePropertyChanged(nameof(HasMissingChapter));
                    RaisePropertyChanged(nameof(IsMissingChapters));
                }
            }
        }

        private string _decimalChapterLabel;
        public string DecimalChapterLabel
        {
            get => _decimalChapterLabel;
            set
            {
                if (!string.Equals(_decimalChapterLabel, value, StringComparison.Ordinal))
                {
                    _decimalChapterLabel = value;
                    RaisePropertyChanged(nameof(DecimalChapterLabel));
                    RaisePropertyChanged(nameof(HasDecimalChapter));
                }
            }
        }
        ...
        public bool IsMissingChapters
        {
            get
            {
                if (string.IsNullOrWhiteSpace(MissingChapterLabel))
                {
                    return false;
                }
                return !string.Equals(MissingChapterLabel, "đủ chapter", StringComparison.OrdinalIgnoreCase) &&
                       !string.Equals(MissingChapterLabel, "complete", StringComparison.OrdinalIgnoreCase);
            }
        }
    }
}
